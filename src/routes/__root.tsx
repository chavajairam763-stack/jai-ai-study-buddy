...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "JAI.AI is your personal AI study partner: chat, PDF analysis, notes, quizzes, exam mode and more — built for students." },
      { property: "og:title", content: "JAI.AI — Your AI Study Partner" },
      { property: "og:description", content: "Learn, solve doubts, summarize and prepare for exams with an AI built for students." },
